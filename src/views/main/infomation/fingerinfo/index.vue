<template>
  <div class="layout-container">
    ...
    <div class="layout-container-table">
      ...
      <Cream ref="cream" :wsocket="wsocket" :layer="layer" @getTableData="getTableData" @creamSuccess="creamSuccess" />
    </div>
  </div>
</template>
...
import { deleteUserFinger } from '@/api/user'
...
// 编辑模态框
const useDialogEffect = (layer, creamflag, cream, wsocket) => {  
  // 编辑弹窗功能
...
// 删除功能
const useDeleEffect = (getTableData, creamflag) => {
  // 删除用户或者访客
...
export default defineComponent({
  ...
  setup() {
    ...
    const { handleEdit } = useDialogEffect(layer, creamflag, cream, wsocket)
    const { fullscreenLoading, handleDel } = useDeleEffect(getTableData, creamflag)
