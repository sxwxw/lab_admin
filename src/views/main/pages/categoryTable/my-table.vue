  ...
  <div class="layout-container">
    ...
    <div class="layout-container-table">
      ...
      >
        ...
        <el-table-column prop="faceStatus" label="是否录入人脸" align="center" />
        <el-table-column prop="touchStatus" label="是否录入指纹" align="center" />
        <el-table-column prop="userTypeId" label="用户类型" align="center" />
        <el-table-column prop="classGroupId" label="所属课题组" align="center" />
        <el-table-column prop="unitId" label="所属单位" align="center" />
